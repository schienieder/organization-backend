    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ipv4_address', models.GenericIPAddressField(protocol='IPv4')),
                ('ipv6_address', models.GenericIPAddressField(protocol='IPv6')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='votes_owner', to='api.user', verbose_name='VOTER')),
            ],
        ),
        migrations.CreateModel(
            name='UserOrg',
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_org_control', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ...
                ('badges', models.ManyToManyField(to='api.Badges', verbose_name='User Badges')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('one_time_code', models.CharField(max_length=50)),
                ('expiration', models.DurationField()),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_auth', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='Reply',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reply_owner', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_owner', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='PollCandidate',
            fields=[
                ...
                ('date_created', models.DateTimeField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='poll_user_candidate', to='api.user', verbose_name='Candidate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_application', to='api.user')),
            ],
        ),
        migrations.AddField(
            model_name='org',
            name='members',
            field=models.ManyToManyField(to='api.User', verbose_name='Organization Member'),
        ),
        migrations.AddField(
            model_name='org',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='org_owner', to='api.user', verbose_name='Organization Owner'),
        ),
        migrations.AddField(
            model_name='org',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='poll_creator', to='api.user', verbose_name='Who created the poll')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_owner', to='api.user', verbose_name='Current User Plan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_code', to='api.user', verbose_name='User Unique Code')),
            ],
        ),
        migrations.AddField(
            model_name='attendance',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='attendance_user_owner', to='api.user', verbose_name='Attendance Owner'),
        ),
    ]
